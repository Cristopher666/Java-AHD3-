...
public class Controlador_Eliminar implements MouseListener, WindowListener {
    ...
    public Controlador_Eliminar (Frm_Eliminar vista, PaisVO pvo, PaisDAO pdao){
    ...
    private void mostrar (){
        ...
        m.setColumnCount(0); // mostrara el orden de las columnas 
        m.addColumn("Id");
        m.addColumn("Nombre del Pais");
        m.addColumn("Capital del Pais");
        m.addColumn("Población del Pais");
        
        for (PaisVO v: pdao.consultarTabla()) {  // mostrara la informacion de las tabla 
