...
public class ControladorModificarDatos implements ActionListener, MouseListener, WindowListener{
    Frm_ModificarDatos vista = new Frm_ModificarDatos();
    PaisVO pvo = new PaisVO();
    PaisDAO pdao = new PaisDAO();

    public ControladorModificarDatos(Frm_ModificarDatos vista, PaisVO pvo, PaisDAO pdao) {
        this.vista = vista;
        this.pvo = pvo;
        this.pdao = pdao;
        
        vista.btnActualizarR.addActionListener(this);
